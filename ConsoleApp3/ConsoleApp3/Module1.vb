...
Module Module1
    ...
    Sub Main()
        ...
        Dim coffee_number As Integer
        Dim coffee_price As Integer
        Dim coffee_type As String
        Dim sucre As Integer
        ...
        If client_food_choice = 5 Then
            ...
            Console.WriteLine("                              1 -->                       COFFEE " & Environment.NewLine)
            Console.WriteLine("                              2 -->                       TEA " & Environment.NewLine)
            Console.WriteLine("                              3 -->                       WATER " & Environment.NewLine)
            Console.WriteLine("                              4 -->                       SODA " & Environment.NewLine)
            Console.WriteLine("                              5 -->                       SOUP " & Environment.NewLine)
            Console.WriteLine("                              6 -->                       COCKTAIL " & Environment.NewLine)
            Console.WriteLine("                              7 -->                       JUICE " & Environment.NewLine)
            Console.WriteLine("                              8 -->                       MILK " & Environment.NewLine)
            Console.WriteLine("                              9 -->                       ENERGY DRINK " & Environment.NewLine & Environment.NewLine)
            ...
            If drink_number = 1 Then
                soundPlayer.Play()
                Console.Clear()
                Console.WriteLine("                                       < COFFEE LIST >" & Environment.NewLine & Environment.NewLine)
                Console.WriteLine("                              1 -->                       ESPRESSO (1 EURO)" & Environment.NewLine)
                Console.WriteLine("                              2 -->                       AMERICANO (1 EURO)" & Environment.NewLine)
                Console.WriteLine("                              3 -->                       LATTE (1 EURO)" & Environment.NewLine)
                Console.WriteLine("                              4 -->                       MACCHIATO (1 EURO) " & Environment.NewLine)
                Console.WriteLine("                              5 -->                       MOCHA (1 EURO) " & Environment.NewLine)
                Console.WriteLine("                              6 -->                       FLAT WHITE (1 EURO) " & Environment.NewLine)
                Console.WriteLine("                              7 -->                       COLD BREW (1 EURO) " & Environment.NewLine)
                Console.WriteLine("                              8 -->                       POUR OVER (1 EURO) " & Environment.NewLine)
                Console.WriteLine("                              9 -->                       FRENCH PRESS (1 EURO) " & Environment.NewLine & Environment.NewLine)
                Console.WriteLine("                              < CHOOSE YOUR COFFEE NUMBER AND PRESS ENTER >" & Environment.NewLine)
                Console.Write("                                                    ")
                coffee_number = Console.ReadLine()
                If coffee_number = 1 Then
                    coffee_type = "ESPRESSO"
                    coffee_price = 1
                End If
                Console.WriteLine("                               < HOW MANY SUCRE YOU WANT ADD IT TO YOUR COFFEE > " & Environment.NewLine & Environment.NewLine)
                Console.WriteLine("                                    1 -->                        0%   sucre  (0g)" & Environment.NewLine)
                Console.WriteLine("                                    2 -->                        25%  sucre  (5g)" & Environment.NewLine)
                Console.WriteLine("                                    3 -->                        50%  sucre  (7g)" & Environment.NewLine)
                Console.WriteLine("                                    4 -->                        75%  sucre  (9g)" & Environment.NewLine)
                Console.WriteLine("                                    5 -->                        100% sucre  (12g)" & Environment.NewLine)
                Console.WriteLine("                               < ENTER THE NUMBER OF THE SUCRE THAT YOU WANT TO ADD > " & Environment.NewLine & Environment.NewLine)
                Console.Write("                                                         ")
                sucre = Console.ReadLine()
                Console.WriteLine("" & Environment.NewLine & Environment.NewLine)
                If sucre = 1 Then
                    Console.WriteLine("                                    < THE MACHINE DON'T ADD ANY SUCRE TO YOUR COFFEE > " & Environment.NewLine & Environment.NewLine)
                End If
            End If
            ...
            Console.WriteLine("                                              >  FIRST NAME    >  " & client_first_name & Environment.NewLine)
            Console.WriteLine("                                              >  LAST NAME     >  " & client_last_name & Environment.NewLine)
            Console.WriteLine("                                              >   COMMAND      >  " & coffee_type & Environment.NewLine)
            Console.WriteLine("                                              >    PRICE       >  " & coffee_price & " EUROS" & Environment.NewLine)
            Console.WriteLine("                                              >  WIFI 200m/s   >" & Environment.NewLine)
            Console.WriteLine("                                              >  key: 0010030  >" & Environment.NewLine)
            Console.WriteLine("                                              >  waiter : jhon >" & Environment.NewLine & Environment.NewLine)
            Console.WriteLine("                                                                         H&M RESTAURANT WISH A GOOD DAY TO YOU :)" & Environment.NewLine)
